...
namespace Vanguard
{
    ...
    public struct ArgumentRange
    {
        ...
        /// <param name="minimum">The minimum value of an argument.</param>
        /// <param name="maximum">The maximum value of an argument.</param>
        public ArgumentRange(float minimum, float maximum)
        {
        ...
        /// <param name="minimum">The minimum value of an argument.</param>
        /// <param name="maximum">The maximum value of an argument.</param>
        public ArgumentRange(double minimum, double maximum)
        {
            Minimum = Convert.ToDecimal(minimum);
            Maximum = Convert.ToDecimal(maximum);
        }
        ...
        /// <param name="minimum">The minimum value of an argument.</param>
        /// <param name="maximum">The maximum value of an argument.</param>
        public ArgumentRange(decimal minimum, decimal maximum)
        {
            Minimum = minimum;
            Maximum = maximum;
        }
        ...
        {
            return InternalValueInRange(Convert.ToDecimal(value));
        }
